...
int main(int argc, char* argv[]) {
    ...
    Graph = TSnap::LoadEdgeList<PUNGraph>("wiki-Vote.txt",0,1);
    PUNGraph G = importarGrafo("wiki-Vote.txt");
    clock_t t;
